...
using ASPNETCore_CRUD.Models.Entities;
...
namespace ASPNETCore_CRUD.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(ASPNETCoreDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone,Address")] User user)
        {
